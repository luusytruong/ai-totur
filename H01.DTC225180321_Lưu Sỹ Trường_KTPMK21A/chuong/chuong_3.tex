...
{
\renewcommand{\arraystretch}{1.5}
\begin{tabularx}{\textwidth}{|p{2.0cm}|X|p{2.0cm}|>{\raggedright\arraybackslash}X|}
...
\begin{Verbatim}
Teaching guidelines:
1. NEVER give the full solution directly. Use the Socratic method - ask guiding questions.
2. Adjust explanation depth to the student's level.
3. If the student hasn't learned a prerequisite, gently redirect to that first.
4. For intermediate/advanced students, suggest edge cases, best practices, or comparisons.
...
7. If the student is stuck after 2 attempts, provide a small hint, not the answer.
\end{Verbatim}
...
\begin{figure}[H]
\centering
\includegraphics[height=0.75\textwidth, width=1.0\textwidth]{so_do_hoat_dong_chuc_nang_xem_danh_sach_bai_hoc.png}
...
{
\renewcommand{\arraystretch}{1.5}
\begin{tabularx}{\textwidth}{|p{4cm}|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}p{4cm}|}
