...
\begin{tabularx}{\textwidth}{|p{2.0cm}|p{4cm}|p{2.0cm}|>{\raggedright\arraybackslash}X|}
...
{
\renewcommand{\arraystretch}{1.5}
\begin{tabularx}{\textwidth}{|p{2.0cm}|p{2.0cm}|>{\raggedright\arraybackslash}X|}
...
{
\renewcommand{\arraystretch}{1.5}
\begin{tabularx}{\textwidth}{|p{2.0cm}|p{4cm}|>{\raggedright\arraybackslash}X|p{2.0cm}|p{2.0cm}|}
...
{
\renewcommand{\arraystretch}{1.5}
\begin{tabularx}{\textwidth}{|p{3.5cm}|X|>{\raggedright\arraybackslash}p{2.0cm}|p{2.0cm}|p{2.0cm}|}
...
Bước 1 - Đăng nhập tài khoản Admin: Tài khoản admin mặc định được tạo sẵn với thông tin đăng nhập: email \textbf{admin@gmail.com}, mật khẩu \textbf{111111}. Sau khi đăng nhập lần đầu, admin nên đổi mật khẩu trong phần cài đặt tài khoản.
...
{
\renewcommand{\arraystretch}{1.5}
\begin{tabularx}{\textwidth}{|p{2.0cm}|p{3cm}|>{\raggedright\arraybackslash}X|p{3cm}|}
