...
import { RegisterInput, RegisterSchema } from "@workspace/types"
  ...
  const onSubmit = (values: RegisterInput) => {
    startTransition(async () => {
      try {
        ...
        console.error(error)
        toast.info("Đã có lỗi xảy ra, vui lòng thử lại sau")
      }
    })
  }
        ...
        <FieldGroup>
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            <h1 className="text-xl font-bold">
              Chào mừng đến với {siteConfig.title}.
            </h1>
            <FieldDescription>
              Bạn đã có tài khoản?{" "}
              <Link
          ...
          <Field>
            <FieldLabel htmlFor="level">Trình độ ban đầu</FieldLabel>
            <FieldContent>
              <Controller
